...
A comunicação entre os serviços é 100% assíncrona via SNS/SQS (ver [ADR 0009](0009_adr_sns_sqs_para_mensageria.md)).
...
Além deles, foram criados repositórios para infraestrutura, frontend e documentação:

- [fiap-12soat-projeto-fase-5-infra](https://github.com/joaosena19/fiap-12soat-projeto-fase-5-infra)
- [fiap-12soat-projeto-fase-5-frontend](https://github.com/joaosena19/fiap-12soat-projeto-fase-5-frontend)
...
* Complexidade operacional maior (6 repositórios, 3 bancos, mensageria, infraestrutura distribuída).
