...
Veja o [relatório completo de cobertura](test_coverage_relatorio_completo.zip) (download do HTML).

![Test Coverage - Relatório](test_coverage_relatorio_resumo.png)
